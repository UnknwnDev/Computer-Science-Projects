...
void print_image_metadata(Image img) {
    std::cout << "File Name: " + img.get_file_name() << std::endl;
    std::cout << "Image Type: " + img.get_image_type() << std::endl;
    std::cout << "Date Created " + img.get_date_created() << std::endl;
    std::cout << "Size (MB): " + std::to_string(img.get_size()) << std::endl;
    std::cout << "Author: " + img.get_author_name() << std::endl;
    std::cout << "Width: " + std::to_string(img.get_width()) << std::endl;
    std::cout << "Height: " + std::to_string(img.get_height()) << std::endl;
    std::cout << "Aperture Size: " + img.get_aperture_size() << std::endl;
    std::cout << "Exposure Time: " + img.get_exposure_time() << std::endl;
    std::cout << "ISO Value: " + std::to_string(img.get_iso_value()) << std::endl;
    std::cout << "Flash Enabled: " + std::string(img.get_flash_enabled() == true ? "True" : "False") << std::endl;
}
